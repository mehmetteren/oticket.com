...
VALUES
  ...
  (5, 10000.00, '123123', '1995-10-15', '12312312312', 'Male');
...
INSERT INTO Route (departure_location, arrival_location, distance, transport_type)
VALUES
  ('Ankara ASTI', 'Istanbul Esenler', 450.123, 'Bus'),
  ('Ercis Otogar', 'Adana Otogar', 1000.678, 'Bus'),
  ('Istanbul Sabiha Gokcen', 'New York JFK', 8216.789, 'Flight'),
  ('Ankara Gar', 'Istanbul Sogutlucesme YHT', 390.123, 'Train'),
  ('Istanbul Sogutlucesme YHT', 'Ankara Gar', 390.123, 'Train'),
  ('Istanbul Esenler', 'Ankara ASTI', 450.123, 'Bus'),
  ('Adana Otogar', 'Ercis Otogar', 1000.678, 'Bus'),
  ('New York JFK', 'Istanbul Sabiha Gokcen', 8216.789, 'Flight');
...
INSERT INTO Schedule (code, departure_datetime, arrival_datetime, 
                        male_female_seats, company_id, vehicle_code, route_id, transfer_code)
VALUES
  ('S001',  '2022-06-15 08:00:00', '2022-06-15 16:00:00', TRUE, 4, 'TK78119', 3, NULL),
  ('S002',  '2022-06-20 10:00:00', '2022-06-20 17:00:00', FALSE, 3, '34T7324', 1, NULL),
  ('S003',  '2022-06-20 12:00:00', '2022-06-20 19:00:00', FALSE, 3, '34T1111', 1, NULL),
  ('S004',  '2022-06-20 14:00:00', '2022-06-20 21:00:00', FALSE, 3, '34T2222', 1, NULL);
